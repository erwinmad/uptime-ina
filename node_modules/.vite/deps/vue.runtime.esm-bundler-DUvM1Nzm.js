		...
		if (forcePatch || hasDynamicProps || patchFlag !== -1) {
			...
			if (shapeFlag & 16 && !(props && (props.innerHTML || props.textContent))) {
				...
				if (next && !isMismatchAllowed(el, 1)) {
					__VUE_PROD_HYDRATION_MISMATCH_DETAILS__ && warn$1(`Hydration children mismatch on`, el, `
Server rendered element contains more child nodes than client vdom.`);
  ...
  - expected on client: ${clientText}`);
			...
			if (props) {
				if (__VUE_PROD_HYDRATION_MISMATCH_DETAILS__ || forcePatch || hasDynamicProps || !optimized || patchFlag & 48) {
					const isCustomElement = el.tagName.includes("-");
					const namespace = el.namespaceURI.includes("svg") ? "svg" : el.namespaceURI.includes("MathML") ? "mathml" : void 0;
					for (const key in props) {
						if (__VUE_PROD_HYDRATION_MISMATCH_DETAILS__ && !(dirs && dirs.some((d) => d.dir.created)) && propHasMismatch(el, key, props[key], vnode, parentComponent)) logMismatchError();
			...
			if (node) {
				...
				if (!hasCheckedMismatch) {
					...
					if (!isMismatchAllowed(container, 1)) {
						__VUE_PROD_HYDRATION_MISMATCH_DETAILS__ && warn$1(`Hydration children mismatch on`, container, `
...
function initFeatureFlags() {
	if (typeof __VUE_OPTIONS_API__ !== "boolean") getGlobalThis().__VUE_OPTIONS_API__ = true;
	if (typeof __VUE_PROD_DEVTOOLS__ !== "boolean") getGlobalThis().__VUE_PROD_DEVTOOLS__ = false;
	if (typeof __VUE_PROD_HYDRATION_MISMATCH_DETAILS__ !== "boolean") getGlobalThis().__VUE_PROD_HYDRATION_MISMATCH_DETAILS__ = false;
}
...
//#endregion
//#region node_modules/.pnpm/@vue+runtime-dom@3.5.42/node_modules/@vue/runtime-dom/dist/runtime-dom.esm-bundler.js
/**
...
//#endregion
//#region node_modules/.pnpm/vue@3.5.42_typescript@7.0.2/node_modules/vue/dist/vue.runtime.esm-bundler.js
/**
* vue v3.5.42
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
