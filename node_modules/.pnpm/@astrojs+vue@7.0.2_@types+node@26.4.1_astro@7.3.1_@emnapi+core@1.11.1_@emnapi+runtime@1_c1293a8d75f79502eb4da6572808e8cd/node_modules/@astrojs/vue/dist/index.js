...
async function getViteConfiguration(command, options) {
  ...
  if (command === "dev" && options?.devtools) {
    ...
    const devToolsOptions = typeof options.devtools === "object" && options.devtools ? options.devtools : {};
    const devToolsPlugins = vueDevTools({
      ...devToolsOptions,
...
function configEnvironmentPlugin() {
  return {
    ...
    configEnvironment(environmentName, _options) {
      ...
      if (environmentName === "client" || (environmentName === "ssr" || environmentName === "prerender") && _options.optimizeDeps?.noDiscovery === false) {
      ...
      if ((environmentName === "ssr" || environmentName === "prerender") && _options.resolve?.noExternal !== true) {
